...
class DeckController(
    ...
    fun createDeck( name:String){
        deckRepository.save(DeckData(name,null,UUID.randomUUID().toString()))
    }
    ...
    fun addWordToDeck(@RequestParam idDeck: String,@RequestParam wordId: String){
       deckService.addWordToDeck(idDeck,wordId)
